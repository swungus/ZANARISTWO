...
if !instance_exists(target)  //follow range
    {
    if distance_to_object(obj_player)>40
    mp_potential_step_object(obj_player.x,obj_player.y,4,obj_solid_parent)
    ddirection=point_direction(x,y,obj_player.x,obj_player.y) 
